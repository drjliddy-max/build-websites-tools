...
describe("C1b isSupportedGa4MeasurementId - accepted forms", () => {
  const accepted = [
    ["representative production shape", "G-CY38LKH4MR"],
...
describe("C1b isSupportedGa4MeasurementId - rejected forms", () => {
  const rejected = [
    ...
    ["second token after newline", "G-CY38LKH4MR\nG-OTHER12345"],
    ["trailing punctuation", "G-CY38LKH4MR."],
    ["leading punctuation", ".G-CY38LKH4MR"],
    ["quoted value", '"G-CY38LKH4MR"'],
    ["url-encoded newline", "G-CY38LKH4MR%0A"],
    ["hyphen inside payload", "G-CY38-LKH4MR"],
    ["Unicode lookalike (Cyrillic С)", "G-СY38LKH4MR"],
    ["Unicode digit lookalike", "G-CY38LKH4MR​"],
