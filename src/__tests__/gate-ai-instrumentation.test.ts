...
test("hasRobotsAiPolicy: matches bare 'AI policy' heading form (siteclinic.io variant)", () => {
  // Pattern shipped by siteclinic-web: a bare "AI policy" heading
  // followed by declaration metadata on the same line. The regex only
  // requires whitespace after "AI policy"; the trailing content is
  // incidental and varies across the owned portfolio.
